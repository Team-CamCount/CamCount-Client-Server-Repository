...
'''
def detect(save_img=False, source=0, conf=0.25, save_txt=False, imgsz=640, trace=False, iou=0.45, agnostic=True, view_img=True, save_conf=True, nosave=True, augment=True, classes=0):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # Apply NMS
        pred = non_max_suppression(pred, conf, iou, classes, agnostic)
